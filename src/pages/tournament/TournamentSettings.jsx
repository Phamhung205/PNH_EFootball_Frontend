...
import { Settings, Lock, AlertTriangle, Save, Trash2, CheckCircle, Trophy, Image as ImageIcon } from 'lucide-react';
  ...
  return (
    <div className={`min-h-screen ${bg} p-4 md:p-6 space-y-5`}>
      ...
      <div className={`rounded-2xl border p-5 space-y-5 ${cardBg}`}>
        ...
        <div>
          <FieldLabel darkMode={darkMode}>Logo URL</FieldLabel>
          <StyledInput value={logo} onChange={(e) => setLogo(e.target.value)} placeholder="https://example.com/logo.png" disabled={disabled} darkMode={darkMode} />
          {logo ? (
